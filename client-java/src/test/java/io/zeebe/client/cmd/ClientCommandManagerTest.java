...
public class ClientCommandManagerTest
{
    ...
    // TODO: iff we keep this test, then add the following test cases
    //   * writes commands as msgpack-encoded json
    //   * cases:
    //     * request timeout
    //     * channel open timeout should lead to retry
    ...
    // TODO: currently makes infinite retries even if they all target the same broker; find improvement
    @Test
    ...
    {
        public FailingCommand(ClientCommandManager client)
        {
            super(client);
        }
