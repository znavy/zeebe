...
{
    private final WorkflowInstanceEventImpl workflowInstanceEvent = new WorkflowInstanceEventImpl(WorkflowInstanceEventType.CREATE_WORKFLOW_INSTANCE.name());

    public CreateWorkflowInstanceCommandImpl(final ClientCommandManager commandManager, String topic, int partition)
    {
        super(commandManager);
        workflowInstanceEvent.setTopicName(topic);
        workflowInstanceEvent.setPartitionId(partition);
    }
