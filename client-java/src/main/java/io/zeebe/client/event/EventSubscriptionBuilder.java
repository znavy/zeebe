...
public interface EventSubscriptionBuilder
{
     ...
     * @return this builder
     */
    EventSubscriptionBuilder handler(EventHandler handler);
     ...
     * @return this builder
     */
    EventSubscriptionBuilder taskEventHandler(TaskEventHandler handler);
     ...
     * @return this builder
     */
    EventSubscriptionBuilder workflowInstanceEventHandler(WorkflowInstanceEventHandler handler);
     ...
     * @return this builder
     */
    EventSubscriptionBuilder incidentEventHandler(IncidentEventHandler handler);
     ...
     * @return this builder
     */
    EventSubscriptionBuilder raftEventHandler(RaftEventHandler handler);
     ...
     * @return this builder
     */
    EventSubscriptionBuilder startAtPosition(long position);
     ...
     * @return this builder
     */
    EventSubscriptionBuilder forcedStart();
     ...
     * @return this builder
     */
    EventSubscriptionBuilder startAtTailOfTopic();
     ...
     * @return this builder
     */
    EventSubscriptionBuilder startAtHeadOfTopic();
     ...
     * @return this builder
     */
    EventSubscriptionBuilder name(String name);
