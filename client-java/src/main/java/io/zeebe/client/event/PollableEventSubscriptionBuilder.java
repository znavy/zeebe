 ...
 * i.e. where the method {@link PollableEventSubscription#poll(TopicEventHandler)} must be invoked
 ...
 */
public interface PollableEventSubscriptionBuilder
{
     ...
     * @return this builder
     */
    PollableEventSubscriptionBuilder startAtPosition(long position);
     ...
     * @return this builder
     */
    PollableEventSubscriptionBuilder startAtTailOfTopic();
     ...
     * @return this builder
     */
    PollableEventSubscriptionBuilder startAtHeadOfTopic();
     ...
     * @return this builder
     */
    PollableEventSubscriptionBuilder name(String subscriptionName);
     ...
     * @return this builder
     */
    PollableEventSubscriptionBuilder forcedStart();
     ...
     */
    PollableEventSubscription open();
}
