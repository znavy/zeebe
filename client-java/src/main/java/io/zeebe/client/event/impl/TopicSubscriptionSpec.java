...
/*
 * TODO: rename classes as follows
 *
 * TopicSubscription => TopicSubscriber
 * TOpicSubscriptionGroup => TopicSubscriberGroup
 * TopicSubscriptionContainer => TopicSubscription
 *
 * TODO: könnten hier auch noch ein Interface einführen, das dann in EventSubscriptionGroup verwendet wird, um so Dinge wie #getTopicName
 *   generisch zu haben
 */
