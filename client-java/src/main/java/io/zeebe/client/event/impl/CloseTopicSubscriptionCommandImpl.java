...
public class CloseTopicSubscriptionCommandImpl extends ControlMessageRequest<Void>
{
    ...
    public CloseTopicSubscriptionCommandImpl(final ClientCommandManager commandManager, String topicName, int partitionId, long subscriberKey)
    {
        // TODO: partition instantiation here is not so great yet
