...
public class FailTaskCmdImpl extends AbstractExecuteCmdImpl<TaskCommand, Long> implements FailTaskCmd
{
    ...
    public FailTaskCmdImpl(final ClientCommandManager commandManager, final ObjectMapper objectMapper, MsgPackConverter msgPackConverter, final Partition topic)
    {
        super(commandManager, objectMapper, topic, TaskCommand.class, TASK_EVENT);
        this.msgPackConverter = msgPackConverter;
    }

    public FailTaskCmdImpl(TopicClientImpl topicClientImpl)
    {
