...
public class SubscriptionManager implements TransportListener
{
    ...
    public EventSubscriptionBuilder newTopicSubscription(TopicClientImpl client)
    {
    ...
    public PollableEventSubscriptionBuilder newPollableTopicSubscription(TopicClientImpl client)
    {
