...
public class WorkflowsClientImpl implements WorkflowsClient
{
    ...
    public CreateDeploymentCommand deploy(String topic)
    {
        ...
        return new CreateDeploymentCommandImpl(client.getCommandManager(), topic, partition);
    }
    ...
    {
        final int partition = 0;
        return new CreateWorkflowInstanceCommandImpl(client.getCommandManager(), topic, partition);
    }
