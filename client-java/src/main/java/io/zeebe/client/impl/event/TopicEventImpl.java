...
public class TopicEventImpl implements Event, EventMetadata
{
    ...
    public TopicEventImpl(final String topicName, final int partitionId, final long key, final long position, final EventType eventType, final byte[] rawContent)
    {
