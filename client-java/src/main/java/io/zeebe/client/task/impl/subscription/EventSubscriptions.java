...
public class EventSubscriptions<T extends EventSubscription<T>>
{
    ...
    public void addSubscription(final T subscription)
    {
        ...
        {
            System.out.println("adding managed subscription " + subscription);
            addManagedSubscription(subscription);
        }
        else
        {
            System.out.println("adding pollable subscription " + subscription);
...
//    }
    ...
    {
        System.out.println("Removing subscription " + subscription + " based on " + managedSubscriptions);
