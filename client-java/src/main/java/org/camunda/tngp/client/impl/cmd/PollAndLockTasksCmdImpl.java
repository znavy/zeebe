    ...
    implements PollAndLockAsyncTasksCmd
{
    ...
    public PollAndLockTasksCmdImpl(ClientCmdExecutor cmdExecutor, DocumentConverter documentConverter)
    {
        super(cmdExecutor, new PollAndLockResponseHandler(documentConverter));
    }
