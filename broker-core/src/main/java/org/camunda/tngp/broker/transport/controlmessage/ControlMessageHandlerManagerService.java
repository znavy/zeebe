...
public class ControlMessageHandlerManagerService implements Service<ControlMessageHandlerManager>
{
    ...
    public void start(ServiceStartContext context)
    {
        ...
        service = new ControlMessageHandlerManager(controlMessageBuffer, errorResponseWriter, controlMessageRequestTimeoutInMillis, taskScheduler, controlMessageHandlers);
