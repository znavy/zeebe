...
public class CreateTopicStreamProcessor implements StreamProcessor, EventProcessor
{
    ...
    // TODO: das hier ist auch repetitiv
    ...
    {
        // TODO: das hier schreibt man in jedem Streamprocessor, um die target metdata richtig hinzubekommen
        //   => sollte an einer Stelle stehen, z.B. StreamProcessorController
    ...
    public boolean executeSideEffects()
    {
        return responseWriter
            ...
            // TODO: repetitiv (und aktuell falsch, siehe issue)
            .position(currentEvent.getPosition())
            // TODO: manchmal repetitiv
            .key(currentEvent.getKey())
            // TODO: etwas repetitiv
            .eventWriter(event)
