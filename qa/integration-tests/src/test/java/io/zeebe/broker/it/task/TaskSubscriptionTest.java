...
public class TaskSubscriptionTest
{
    ...
    public void shouldOpenSubscription() throws InterruptedException
    {
        ...
        assertThat(tasks.get(0).getMetadata().getEventKey()).isEqualTo(task.getMetadata().getEventKey());
    }
    ...
    public void shouldCompleteTask() throws InterruptedException
    {
        ...
        // then
        assertThat(result.getMetadata().getEventKey()).isEqualTo(task.getMetadata().getEventKey());
    ...
    public void shouldCompletionTaskInHandler() throws InterruptedException
    {
        ...
        assertThat(subscribedTask.getMetadata().getEventKey()).isEqualTo(task.getMetadata().getEventKey());
    ...
    public void shouldFetchAndHandleTasks()
    {
        ...
        final RecordingTaskHandler handler = new RecordingTaskHandler((c, t) -> c.completeTask());
    ...
    public void shouldMarkTaskAsFailedAndRetryIfHandlerThrowsException()
    {
        ...
        final long taskKey = task.getMetadata().getEventKey();
        assertThat(taskHandler.getHandledTasks()).extracting("metadata.eventKey").containsExactly(taskKey, taskKey);
    ...
    public void shouldUpdateTaskRetries()
    {
        ...
        // then
        assertThat(updatedTask.getMetadata().getEventKey()).isEqualTo(task.getMetadata().getEventKey());
    ...
    public void shouldExpireTaskLock() throws InterruptedException
    {
        ...
        assertThat(taskHandler.getHandledTasks())
            .hasSize(2)
            .extracting("metadata.eventKey").containsExactly(taskKey, taskKey);
    ...
    {
        // given
        final RecordingTaskHandler taskHandler = new RecordingTaskHandler((c, t) -> c.completeTask());
    ...
    public void shouldPollTasks()
    {
        ...
        assertThat(subscribedTasks.getMetadata().getEventKey()).isEqualTo(task.getMetadata().getEventKey());
        ...
        assertThat(subscribedTasks.getHeaders()).containsEntry("b", "2");
