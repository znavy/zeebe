...
public class MultipleClientTest
{
    ...
    public void shouldOpenTaskSubscriptionsForDifferentTypes()
    {
        ...
        assertThat(handler1.getHandledTasks().get(0).getMetadata().getEventKey()).isEqualTo(task1.getMetadata().getEventKey());

        assertThat(handler2.getHandledTasks()).hasSize(1);
        assertThat(handler2.getHandledTasks().get(0).getMetadata().getEventKey()).isEqualTo(task2.getMetadata().getEventKey());
    }
