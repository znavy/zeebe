...
public class ClientApiRule extends ExternalResource
{
    ...
    // TODO: to provide these kind of APIs, we need to be able to collect all messages in the order they are received
    //   => could replace the receive handler when the client transport is built by one that
    //      does the default behavior and also logs all the received messages
